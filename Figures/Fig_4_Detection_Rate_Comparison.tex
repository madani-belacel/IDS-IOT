...
\addplot[fill=red!40] table[x=scenario,y=mean_det_rate,col sep=comma]{data/real/parsed/agg/fig4_detection_rate_B2.csv};
\addplot[fill=orange!50] table[x=scenario,y=mean_det_rate,col sep=comma]{data/real/parsed/agg/fig4_detection_rate_B3.csv};
