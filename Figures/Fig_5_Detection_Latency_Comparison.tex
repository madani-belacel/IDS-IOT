...
\addplot[fill=red!40] table[x=scenario,y=mean_latency_s,col sep=comma]{data/real/parsed/agg/fig5_latency_B2.csv};
\addplot[fill=orange!50] table[x=scenario,y=mean_latency_s,col sep=comma]{data/real/parsed/agg/fig5_latency_B3.csv};
