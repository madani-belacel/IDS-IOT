...
The results reported here correspond to a pilot Cooja study rather than a completed large-scale real-world deployment campaign. The objective of this manuscript is therefore to demonstrate feasibility, reproducibility, and relative trends under controlled conditions, not to claim definitive real-world performance at scale. The figures and tables in this manuscript are generated from the available parsed campaign logs and should be interpreted as provisional measurements until a full replicated campaign is completed.
