...
\begin{figure}[!t]
  \centering
  \resizebox{\linewidth}{!}{\input{Figures/Fig_1_ClusterIDS_Architecture.tex}}
...
Application flows are mapped to four priority classes $C0$--$C3$, where $C0$ denotes background telemetry and $C3$ denotes safety- or control-critical traffic.
...
\begin{figure}[!t]
  \centering
  \resizebox{\linewidth}{!}{\input{Figures/Fig_2_DODAG_Cluster_Overlay.tex}}
...
\begin{figure}[!t]
  \centering
  \resizebox{\linewidth}{!}{\input{Figures/Fig_3_Context_Policy_Weights.tex}}
