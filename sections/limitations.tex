...
\begin{itemize}
  ...
  \item \textbf{50-node grid only.} The pilot campaign covers the 50-node grid (21 seeds CLUSTERIDS, 3 seeds ablation, 5 attack scenarios).
  ...
  Future work should strengthen these mechanisms through head attestation protocols, threshold-based quorum confirmation among multiple heads covering overlapping regions, and reputation-aware rotation that penalizes heads exhibiting inconsistent reporting behavior.
  \item \textbf{Traffic-priority labeling.} The evaluation assumes that flows can be mapped to $C0$--$C3$ (Table~\ref{tab:traffic-classes}).
