...
\begin{enumerate}
  ...
  \item a \textbf{Contiki-NG implementation and reproducible Cooja evaluation pilot campaign} on a 50-node grid with five attack scenarios (R1--R4 individually and combined) and 3 random seeds.
\end{enumerate}
