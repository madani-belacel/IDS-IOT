...
This section presents evaluation results from the pilot Cooja campaign (3 seeds, 5 attack scenarios, 50-node grid).
...
Table~\ref{tab:statistics} presents pairwise comparisons (RPL-ClusterIDS vs.\ B1 on DR; Full vs.\ Eco on DR).
