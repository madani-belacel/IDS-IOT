...
In the pilot campaign, RPL-ClusterIDS reached 80.6\% campaign-level DR, while the B1 baseline remained at 0\% DR, yielding $p < 0.05$ (Welch's $t$-test; preliminary with $n=21$ and $n=3$).
