...
Parsed logs are archived under \path{data/real/parsed/}. CPU, RAM, and energy values in the pilot campaign are pipeline placeholders generated from node-logical properties; real Energest measurements will replace them in the full campaign. Detection rates and FPR reflect the simulated IDS overlay state as captured by the Cooja tick-based metrics pipeline.
