...
\begin{itemize}
  \item Repository: \url{https://github.com/madani-belacel/RPL-ClusterIDS}
  \item Release v1.0 (complete ZIP package): \url{https://github.com/madani-belacel/RPL-ClusterIDS/releases/tag/v1.0}
...
All firmware, campaign scripts, parsed datasets, and figure-generation code are publicly available at \url{https://github.com/madani-belacel/RPL-ClusterIDS/releases/tag/v1.0}.
