...
RPL-ClusterIDS follows reproducible-research practices aligned with IEEE Internet of Things Journal expectations.
...
The IEEE manuscript is compiled from \texttt{main-ieee.tex}:
\begin{verbatim}
pdflatex main-ieee && bibtex main-ieee &&
pdflatex main-ieee && pdflatex main-ieee
\end{verbatim}
